...
def is_between_100_and_999(user_input_number):
    ...
    if int_num >= 100 and int_num < 1000:
        result = True
    else:
        result = False
    # ==================================
...
def is_duplicated_number(three_digit):
    ...
    result = None
    set_three_digit = set(three_digit)
    len_set_three_digit = len(set_three_digit)
    if len_set_three_digit == 1 or len_set_three_digit == 2:
        result = True
    else:
        result = False
    # ==================================
...
def is_validated_number(user_input_number):
    ...
    result = None
    n = user_input_number
    if is_digit(n) and is_between_100_and_999(n) and not is_duplicated_number(n):
        result = True
    else:
        result = False
    # ==================================
...
def get_not_duplicated_three_digit_number():
    ...
    while True:
        ...
        str_get_random_number = str(random_number)
        if not is_duplicated_number(str_get_random_number):
            break
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    ball = 0
    # check strike
    list_input_number = list(user_input_number)
    list_random_number = list(random_number)
    for i in range(0, 3):
        if list_input_number[i] == list_random_number[i]:
            strikes = strikes + 1
    # check ball
    set_number = set(user_input_number)
    set_number.update(set(random_number))
    len_set_number = len(set_number)
    if len_set_number == 5:
        if strikes != 1:
            ball = 1
    elif len_set_number == 4:
        if strikes == 1:
            ball = 1
        elif strikes == 0:
            ball = 2
    elif len_set_number == 3:
        if strikes == 0:
            ball = 3
        elif strikes == 1:
            ball = 2
...
def is_yes(one_more_input):
    ...
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    result = None
    upper_one_more_input = one_more_input.upper()
    if upper_one_more_input == "Y" or upper_one_more_input == "YES":
        result = True
    else:
        result = False
    # ==================================
...
def is_no(one_more_input):
    ...
    result = None
    upper_one_more_input = one_more_input.upper()
    if upper_one_more_input == "N" or upper_one_more_input == "NO":
        result = True
    else:
        result = False
    # ==================================
...
def main():
    ...
    while is_yes(one_more) and user_input is not "0":  # display Random Number
        random_number = str(get_not_duplicated_three_digit_number())
        print("Random Number is :  ", random_number)

        while not is_validated_number(user_input) or result[0] != 3:
        ...
        while user_input is not "0":
            ...
            if is_yes(one_more) or is_no(one_more):
                ...
                print("Wrong Input, Input again")
        if is_no(one_more) or user_input is "0":
