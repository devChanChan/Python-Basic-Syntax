...
def merge_and_sort(list_data_a, list_data_b):
    ...
    result = []
    for a in list_data_a:
        result.append(a)
    for b in list_data_b:
        if not(b in list_data_a):
            result.append(b)
    result.sort()
    # ==================================
    return result
...
def main():
    ...
    # 싶은 코드를 자유롭게 작성하시오
    print ("SUM Test")
    print (sum_of_list([1, 2, 3])) # Expected Result: 6
    print (sum_of_list([5, 5, 10]) == 20) # Expected Result: True
    print ("SUM Test Closed \n")

    print ("Merge&Sort Test")
    print (merge_and_sort([1, 2, 3, 10], [5, 6, 7, 8])) # Expected Result: [1, 2, 3, 5, 6, 7, 8, 10]
    print (merge_and_sort(['a', 'b', 'z'], ['c', 'd', 'f'])) # Expected Result: ['a', 'b', 'c', 'd', 'f', 'z']
    print ("Merge&Sort Test Closed \n")

    print ("Delete element Test")
    print (delete_a_list_element([1, 2, 3, 10], 1)) # Expected Result: [2, 3, 10]
    print (delete_a_list_element(['a', 'b', 'c', 'z'], 'd')) # Expected Result: 0
    print ("Delete element Test Closed \n")

    print ("Comparison size Test")
    print (comparison_list_size([1, 2, 3, 4, 5, 6], [1, 2, 3])) # Expected Result: [1, 2, 3, 4, 5, 6]
    print (comparison_list_size([1, 2, 3, 4, 5, 6], [1, 2, 3, 5, 7, 8, 9, 10])) # Expected Result: [1, 2, 3, 5, 7, 8, 9, 10]
    print ("Comparison size Test Closed \n")

    print ("Odd Even Test")
    print (odd_even_check(5, 6)) # Expected Result: 'Odd'
    print (odd_even_check(5, 5)) # Expected Result: 'Even'
    print ("Odd Even Test Closed \n")

    print ("Discount Price Test")
    print (discount_price(40000)) # Expected Result: 36000.0
    print (discount_price(110000)) # Expected Result: 88000.0
    print ("Discount Price Test Closed \n")

    print ("Find smallest Test")
    print (find_smallest_value([1, 2, 3, 4, 5])) # Expected Result: '1'
    print (find_smallest_value([5, 4, 3, 0, 100, 200])) # Expected Result: '0'
    print ("Find smallest Test Closed \n")

    print ("Binary converter Test")
    print (binary_converter(100)) # Expected Result: '1100100'
    print (binary_converter(56)) # Expected Result: '111000'
    print ("Binary converter Test Closed \n")

    print ("Number of cases Test")
    print (number_of_cases(['a', 'b', 'c'])) # Expected Result: ['aa', 'ab', 'ac', 'ba', 'bb', 'bc', 'ca', 'cb', 'cc']
    print (number_of_cases(['a', 'a'])) # Expected Result: ['a', 'a']
    print (number_of_cases([1, 2, 3, 'a'])) # Expected Result: ['11', '12', '13', '1a', '21', '22', '23', '2a', '31', '32', '33', '3a', 'a1', 'a2', 'a3', 'aa']
    print ("Number of cases Test Closed \n")
    # ==================================
