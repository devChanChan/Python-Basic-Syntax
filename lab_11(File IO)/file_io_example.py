...
def get_number_of_characters_without_blank(filename):
    ...
    # ===Modify codes below=============
    contents = get_file_contents(filename)
    contents_without_blank = ''.join(contents.split())
    result = len(contents_without_blank)
    # ==================================
    return result
...
def get_number_of_lines(filename):
    ...
    # ===Modify codes below=============
    contents = get_file_contents(filename)
    result = len(contents.strip().split('\n'))
    # ==================================
    return result
...
def get_number_of_target_words(filename, target_words):
    ...
    result = contents_lower.count(target_words.lower())
    # ==================================
    return result
